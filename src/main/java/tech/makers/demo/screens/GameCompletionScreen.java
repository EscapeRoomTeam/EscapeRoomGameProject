...
public class GameCompletionScreen {
    ...
    public GameCompletionScreen(Stage primaryStage, EscapeRoomGame game) {
    ...
    private void initialize() {
        ...
        Image backgroundImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/sprites/background4.gif")));
        ImageView backgroundImageView = new ImageView(backgroundImage);
        backgroundImageView.setFitWidth(800);
        backgroundImageView.setFitHeight(600);
        backgroundImageView.setPreserveRatio(false);

        root.getChildren().add(backgroundImageView); // Add background image to the root first
        ...
        String message = "Congratulations on completing the game! Thank you for playing.";
        animateText(speechBubble, message);

        // Add exit button
        Button exitButton = new Button("Exit");
        exitButton.setOnAction(e -> { primaryStage.close(); stopAudio(); });
