...
public class Level2 extends Player.Level {
    ...
    public Level2() {
        super(
                ...
                new Safe(400, 200, "/sprites/Router.png", "1234")
        );
    }

    private static List<Puzzle> createPuzzles() {
        List<Puzzle> puzzles = new ArrayList<>();
//        puzzles.add(new Puzzle(300, 300, "What is the capital of France?", "Paris", "/sprites/Computer.png"));
//        puzzles.add(new Puzzle(400, 150, "Say Hi", "Hi", "/sprites/Computer.png"));
        return puzzles;
    }
}